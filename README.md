...
[`Exposition/Contents.md`](Exposition/Contents.md) for the intended reading order.

## Exposition

The top-level `Exposition/` directory is a mixed publication surface. `Preamble.md`, `Theory.md`, `Theorems.md`, `Identification.md`, and `Reading.md` are hand-authored sources. `Contents.md`, `Assumptions.md`, and `Glossary.md` are generated by `lake exe exposition_gen`, checked in, and retain their `GENERATED ... do not edit` headers.
