...
The top-level `Exposition/` directory is a mixed publication surface. `Preamble.md`, `Theory.md`, `Theorems.md`, and `Identification.md` are hand-authored sources. `Contents.md`, `Assumptions.md`, and `Glossary.md` are generated by `lake exe exposition_gen`, checked in, and retain their `GENERATED ... do not edit` headers.
